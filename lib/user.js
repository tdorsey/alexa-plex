    ...
    if (!this.libraries || forceReset) {
        return plexutils.getLibrarySections(context._app)
            .then(function(directories) {
                console.log("updating user lib with directories: " + JSON.stringify(directories.MediaContainer.Directory));
                return db.updateUserLibraries(context, directories.MediaContainer.Directory)
                    .then(function() {
                        return true;
                    })
        })
